                        ...
                        <div class="card-body">
                            <form class="row g-3" method="POST">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" class="form-control" id="PrezzoMag" name="price_adult"
                                           placeholder="Prezzo O18" required>
                                </div>
                                <div class="col-md-3">
                                    <label for="PrezzoMin" class="form-label">Prezzo ragazzi*</label>
                                    <input type="number" class="form-control" id="PrezzoMin" name="price_underage"
                                           placeholder="Prezzo U18" required>
